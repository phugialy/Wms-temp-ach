-- Fix SKU Matching View - Add back device_test table for notes field
-- This migration restores the notes field needed for carrier override logic
...
-- 2. Create the fixed main SKU matching view (includes device_test for notes)
...
-- 7. Create a summary view for reporting
...
COMMENT ON VIEW sku_matching_view IS 'Enhanced SKU matching view with device_test notes for carrier override logic';

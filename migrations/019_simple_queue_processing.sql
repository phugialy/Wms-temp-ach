-- ========================================
-- SIMPLIFIED QUEUE PROCESSING FUNCTION
-- ========================================

-- Simplified function to process all pending queue items and create actual database records
-- This version avoids variable name conflicts and ambiguous column references

-- Comprehensive queue processing function that handles multiple items
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      -- Insert into item table if we have the required fields
      ...
      -- Insert into device_test table if we have working status
